...
export const UNIT_COSTS: Record<CareCategory, UnitCostRef> = {
  ...
  MEDICATION: { unit: 2400, source: "Annual pharmacy cash-pay (bundled estimate)", cpt: undefined },
  INJECTION: { unit: 1850, source: "UCR image-guided injection", cpt: "20610" },
  IMAGING: { unit: 1350, source: "FAIR Health / CMS diagnostic fee schedule", cpt: "73721" },
  LABS: { unit: 220, source: "UCR lab panel", cpt: "80053" },
  DME: { unit: 3200, source: "DMEPOS + replacement schedule (bundled estimate)", cpt: undefined },
  ...
  HOME_MODIFICATION: { unit: 28000, source: "Contractor ADA modification (bundled estimate)", cpt: undefined },
  VEHICLE_MODIFICATION: { unit: 42000, source: "Adaptive vehicle + hand controls (bundled estimate)", cpt: undefined },
  ATTENDANT_CARE: { unit: 62000, source: "Home health aide annual (hrs × UCR) (bundled estimate)", cpt: undefined },
  SKILLED_NURSING: { unit: 128000, source: "SNF/LPN annual (bundled estimate)", cpt: undefined },
  CASE_MANAGEMENT: { unit: 4800, source: "RN case management annual", cpt: "T2022" },
  VOCATIONAL_REHAB: { unit: 8500, source: "Vocational evaluation + services (bundled estimate)", cpt: undefined },
  ...
  COMPLICATION_MANAGEMENT: { unit: 15000, source: "UCR complication episode (bundled estimate)", cpt: undefined },
  ASSISTIVE_TECH: { unit: 5200, source: "AAC / assistive technology (bundled estimate)", cpt: undefined },
  SUPPLIES: { unit: 1800, source: "Annual medical supplies (bundled estimate)", cpt: undefined },
  TRANSPORTATION: { unit: 3600, source: "Medical transport annual (bundled estimate)", cpt: undefined },
  MISC: { unit: 1500, source: "Miscellaneous medical need (bundled estimate)", cpt: undefined },
};
