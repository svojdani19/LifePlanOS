...
export const CONDITION_CARE: Record<ConditionKey, CareTemplate[]> = {
  LUMBAR_SPINE: [
    ...
    item({ category: "INJECTION", service: "Lumbar transforaminal epidural steroid injection", specialty: "Interventional Pain", rationale: "Interventional control of radicular pain.", cptCode: "64483", frequencyPerYear: 3, durationYears: 10, unitCost: 3345, probability: "PROBABLE", evidenceStrength: G, defenseVulnerability: "MODERATE", confidence: 65 }),
