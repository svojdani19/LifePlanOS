...
See [05_SYSTEM_ARCHITECTURE.md](05_SYSTEM_ARCHITECTURE.md). Summary: single Next.js 14 App Router
...
See [06_DATABASE_SPEC.md](06_DATABASE_SPEC.md). The **Case** is the root aggregate; every
...
See [11_SECURITY.md](11_SECURITY.md). Non-negotiables: hashed session
...
See [10_REPORT_ENGINE.md](10_REPORT_ENGINE.md). Locked design: Garamond serif, navy
